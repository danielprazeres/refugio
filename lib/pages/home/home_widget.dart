        ...
        appBar: AppBar(
          ...
          title: Align(
            ...
            child: Row(
              ...
              children: [
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 24.0, 8.0, 0.0),
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(8.0),
                    child: Image.asset(
                      'assets/images/icon_refugio-transformed.png',
                      width: 30.0,
                      height: 20.0,
                      fit: BoxFit.cover,
                    ),
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  _model.contatoEmergencia =
                                      await queryContatoEmergenciaRecordOnce(
                                    queryBuilder: (contatoEmergenciaRecord) =>
                                        contatoEmergenciaRecord.where(
                                            'contato_vinculo_usuario',
                                            isEqualTo: currentUserUid),
                                    singleRecord: true,
                                  ).then((s) => s.firstOrNull);
                                  if (_model.contatoEmergencia!.telefone !=
                                          null &&
                                      _model.contatoEmergencia!.telefone !=
                                          '') {
                                    if (isiOS) {
                                      await launchUrl(Uri.parse(
                                          "sms:'+55${_model.contatoEmergencia!.telefone}'&body=${Uri.encodeComponent('Esse é um Teste REFUGIO. Localização: ${currentUserLocationValue?.toString()}')}"));
                                    } else {
                                      await launchUrl(Uri(
                                        scheme: 'sms',
                                        path:
                                            '+55${_model.contatoEmergencia!.telefone}',
                                        queryParameters: <String, String>{
                                          'body': Uri.encodeComponent(
                                              'Esse é um Teste REFUGIO. Localização: ${currentUserLocationValue?.toString()}'),
                                        },
                                      ));
                                    }
                                  }
